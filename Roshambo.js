...
//Display message
if(winner == 'user') {
    winnerMsg = "User has won!";
}

if(winner == 'computer') {
    winnerMsg = "Computer has won!";
}
...
content.innerHTML = "<p>"+winnerMsg+"</p>";

//Reload page button
contentElement.innerHTML += "<button type=\"button\" id=\"reloadButton\" onclick=\"location.reload();\">Try again?</button>";
